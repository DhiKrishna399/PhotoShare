...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Responds to which user was clicked and loads images from their feed
        //By default, if a user has no images the default camera logo is shown
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode == 1 && resultCode == RESULT_OK && data != null){
            try{
                ...
                ParseObject object = new ParseObject("Picture");
                ...
                object.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        if(e == null){
                            ...
                            e.printStackTrace();
                            Toast.makeText(UserActivity.this, "Error uploading image", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
